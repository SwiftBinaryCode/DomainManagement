...
namespace DomainManagement.Persistence.Migrations
{
    ...
    [Migration("20231015083201_SecondMigration")]
            ...
            modelBuilder.Entity("DomainManagement.Domain.DomainType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTime(2023, 10, 15, 10, 32, 1, 523, DateTimeKind.Local).AddTicks(4078),
                            DateModified = new DateTime(2023, 10, 15, 10, 32, 1, 523, DateTimeKind.Local).AddTicks(4117),
